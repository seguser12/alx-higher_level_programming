...
class Base:
    ...
    def to_json_string(list_dictionaries):
        '''creates json rep of list dictionaries'''
    ...
    def create(cls, **dictionary):
        '''creates obj with given attributes'''
        polygons = {
    ...
    def load_from_file(cls):
        '''load from a file in json format'''
        file_name = '{}.json'.format(cls.__name__)
        lines = []
    ...
    def save_to_file_csv(cls, list_objs):
        '''save a list to a file in csv format'''
    ...
    def draw(list_rectangles, list_squares):
        '''draws a list using Turtle graphics'''
        poly_list = []
        funcs = {
